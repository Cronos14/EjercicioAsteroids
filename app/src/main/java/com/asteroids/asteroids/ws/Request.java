...
public class Request {
    ...
    public static JSONObject request(String requestURL, String params, boolean contentTypeJson, HashMap<String,String> headers, String method){
    ...
    public static String convertParametersToGet(HashMap<String,String> params){
        String paramsGet = "";

        for (String key : params.keySet()) {
            paramsGet+=key+"="+params.get(key)+"&";
        }
